...
10. 按 A–F 六维模型评估并输出 `audit.md`、`audit.html`、`audit.json`（含 `indicator_register`）与输入快照，共 A1–A3、B1–B3、C1–C3、D1–D4、E1–E2、F1–F6 六维 21 子项。
...
- `references/dimension-model.md`：六维评估模型（A1–A3、B1–B3、C1–C3、D1–D4、E1–E2、F1–F6，共 21 子项）完整阐述。
